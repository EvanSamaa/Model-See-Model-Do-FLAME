...
# Paths resolve relative to the repo root: pretrained_models/flame/
_FLAME_DIR = Path(__file__).parent.parent.parent / "pretrained_models" / "flame"

FLAMEConfig = SimpleNamespace(
    flame_model_path=str(_FLAME_DIR / "generic_model.pkl"),
    n_shape=100,
    n_exp=100,
    n_tex=50,
    tex_type='BFM',
    tex_path=str(_FLAME_DIR / "FLAME_albedo_from_BFM.npz"),
    flame_lmk_embedding_path=str(_FLAME_DIR / "landmark_embedding.npy"),
)
